...
float posCurrent = 400;
int t = 0;
void Laborator3::Update(float deltaTimeSeconds)
{
	// TODO: update steps for translation, rotation, scale, in order to create animations
	//float sx, sy;
	modelMatrix = glm::mat3(1); //matrice identitate
	//modelMatrix *= Transform2D::Translate(150, 250); // *= la transformari in ordine inversa (inmultire dreapta)
