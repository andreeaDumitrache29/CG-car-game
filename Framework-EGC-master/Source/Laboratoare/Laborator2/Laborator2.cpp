...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0.75, 1)),
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0.5, 1)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0.5, 0.23)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0.15, 0.56)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0.18, 0.98)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0.74, 0.84)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.5, 0.784, 1))
		...
		{
			VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0.75, 1)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0.5, 1)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0.5, 0.23)),
		};
		vector<VertexFormat> vertices3
		{
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0.75, 1)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 0.5, 1)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0.5, 0.23)),
		};
		...
		for (int ii = 0; ii < num_segments; ii++)
		{
			...
			vertices_circle.push_back(VertexFormat(glm::vec3(x, y, 0), glm::vec3(1, 0, 0)));
		}
		...
		for (int ii = num_segments; ii >  2; ii--)
		{
			indices_circle.push_back(0);
			indices_circle.push_back(ii);
			indices_circle.push_back(ii - 1);
		}
		...
		Mesh *tetra = CreateMesh("tetraedru", vertices2, indices2);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(2, 0.5f, 0), glm::vec3(0.25f));
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.75, -0.5f, 0), glm::vec3(0.25f));
	RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(0, 0, 4), glm::vec3(1));
